...
- **`@category`** — groups functions in the TypeDoc sidebar. Use the module name: `array`, `async`, `color`, `datetime`, `dom`, `math`, `object`, `sanitize`, `storage`, `string`, `timing`, `types`, `url`, `validation`.
